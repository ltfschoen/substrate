...
fn election_simple_tally_should_work() {
	ExtBuilder::default().build().execute_with(|| {
		...
		System::set_block_number(6);
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(4), 2, 20, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(4), 5, 50, 0), Ok(None.into()));
...
fn election_presenting_for_double_election_should_not_work() {
	ExtBuilder::default().build().execute_with(|| {
		System::set_block_number(4);
		assert_eq!(Elections::submit_candidacy(Origin::signed(2), 0), Ok(None.into()));
		assert_ok!(Elections::set_approvals(Origin::signed(2), vec![true], 0, 0, 20));
		assert_ok!(Elections::end_block(System::block_number()));
...
fn election_loser_candidates_bond_gets_slashed() {
	ExtBuilder::default().desired_seats(1).build().execute_with(|| {
		...
		System::set_block_number(6);
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(4), 4, 10, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(3), 3, 10, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(2), 2, 10, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(1), 1, 50, 0), Ok(None.into()));
...
fn pot_accumulating_weight_and_decaying_should_work() {
	ExtBuilder::default().balance_factor(10).build().execute_with(|| {
		...
		assert_eq!(Elections::present_winner(Origin::signed(6), 6, 600, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(5), 5, 500, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(1), 1, 100, 0), Ok(None.into()));
		...
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(6), 6, 600, 1), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(5), 5, 500, 1), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(1), 1, 100 + Elections::get_offset(100, 1), 1), Ok(None.into()));
		...
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(6), 6, 600, 2), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(5), 5, 500, 2), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(1), 1, 100 + Elections::get_offset(100, 2), 2), Ok(None.into()));
		...
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(6), 6, 600, 3), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(5), 5, 500, 3), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(1), 1, 100 + Elections::get_offset(100, 3), 3), Ok(None.into()));
...
fn pot_winning_resets_accumulated_pot() {
	ExtBuilder::default().balance_factor(10).build().execute_with(|| {
		...
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(6), 6, 600, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(4), 4, 400, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(3), 3, 300, 0), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(2), 2, 300, 0), Ok(None.into()));
		...
		assert!(Elections::presentation_active());
		assert_eq!(Elections::present_winner(Origin::signed(6), 6, 600, 1), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(4), 4, 400, 1), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(3), 3, 300 + Elections::get_offset(300, 1), 1), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(2), 2, 300 + Elections::get_offset(300, 1), 1), Ok(None.into()));
		...
		assert_eq!(Elections::present_winner(Origin::signed(3), 2, 300, 2), Ok(None.into()));
		assert_eq!(Elections::present_winner(Origin::signed(4), 4, 400 + Elections::get_offset(400, 1), 2), Ok(None.into()));
		assert_ok!(Elections::end_block(System::block_number()));
